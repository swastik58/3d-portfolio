        ...
        <div className='relative w-full h-[230px]'>
          ...
          <div className='absolute inset-0 flex gap-2 justify-end m-3 card-img_hover'>
            ...
            <div onClick={() => window.open(link, "_blank")}
              className='black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer'
            >
              <img src={links} alt="github" className='w-1/2 h-1/2 object-contain' />
            </div>
          </div>
        </div>
  ...
  return (
    ...
    <div className='w-full flex'>
      <motion.p variants={fadeIn("", "", 0.1, 1)}
        className='mt-3 text-secondary text-[24px] max-w-3xl leading-[30px]'
      >
    ...
    <div className='mt-20 flex flex-wrap gap-7'>
      {projects.map((project, index) => (
        ...
        <br /> <br />
      <motion.div variants={textVariant()}>
        <a href="https://github.com/swastik58?tab=repositories" target="_blank">
          <h4 className='text-[30px] hover:text-red-800'>For more of my projects visit my Github Repositories Page</h4>
        </a>
      </motion.div>
